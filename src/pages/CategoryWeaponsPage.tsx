...
const CategoryWeaponsPage: React.FC<CategoryWeaponsPageProps> = ({ weaponIndex }) => {
      ...
      if (category) {
        try {
          const promises = category.weapons.map(async (weapon) => {
            ...
            if (!response.ok) {
              throw new Error(`Failed to fetch weapon data for ${weapon.slug}: ${response.statusText}`);
            }
              ...
              <div className="weapon-details">
                ...
                <div className="weapon-stats">
                  <table className="weapon-stats-table">
                    <thead>
                      <tr>
                        <th colSpan={5}>Attack Power / Damage Reduction (%)</th>
                        <th colSpan={2}>Effects</th>
                        <th colSpan={3}>Durability / Weight - Attack Type</th>
                      </tr>
                      <tr>
                        <th>Physical</th>
                        <th>Magic</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td colSpan={5}></td> {/* Empty space for alignment */}
                      </tr>
                    </tbody>
                  </table>
                </div>
